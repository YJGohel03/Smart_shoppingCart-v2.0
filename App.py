...
classNames = []
classFile = "C:/Users/devin/OneDrive/Desktop/yash/Smapca_Trolley/coco.names"
with open(classFile, "rt") as f:
    classNames = f.read().rstrip("\n").split("\n")

configPath = "C:/Users/devin/OneDrive/Desktop/yash/Smapca_Trolley/ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt"
weightsPath = "C:/Users/devin/OneDrive/Desktop/yash/Smapca_Trolley/frozen_inference_graph.pb"
...
class ShoppingCartApp:
    ...
    def show_popup(self, title, message):
        ...
        msg_label.pack(pady=20, padx=10, expand=True)
    ...
    def show_welcome_screen(self):
        ...
        # Logo at bottom
        try:
            logo_image = Image.open("LOGO PATH")
    ...
    def process_barcode(self, barcode):
        ...
        if item:
            ...
            self.show_popup("Not Found", "Item not found in the database.")
                ...
                if self.is_object_in_database(obj[1]):
                    if obj[1] not in self.detected_objects:
                        ...
                        if not self.scanned_product:
                            self.show_popup("Object Detected", f"{obj[1]} detected. Please scan its barcode.")
    ...
    def process_payment(self):
        if not self.items:
            self.show_popup("Empty Cart", "Your cart is empty. Add items to proceed.")
            return
